		...
		<div class="form-login">
			...
			<div class="social-icons">
				...
				<ul class="login_link_box">
					<li class="login_li"><a href="/searchId" class="fonthover">아이디
							찾기</a> &nbsp;</li>
				...
				<div class="social_login">
					...
					<ul class="social_logo" style="height: 150px; margin-left: -20px;">
						...
						<li class="box_list">
						<!--  <a href="https://kauth.kakao.com/oauth/authorize?client_id=e862dc15e41ee83edaac20240a8bc9e5&redirect_uri=http://localhost:8080/member/kakaoLogin&response_type=code">-->
