...
">
	...
	<form action="/users/update?id=${login_info.id}" method="post" name="mypage" id="mypage" style="width:950px;border:2px solid#323232;padding-bottom: 10px;">
		...
		<tr style="border-top:20px solid white;">
			...
			<td style="padding-left: 50px;"><input type="password" class="pwd" id="pwd" name="pwd"  required><br>
			</td>
		...
		<tr style="border-top:20px solid white;">
			...
			<td style="padding-left: 50px;"><input type="password" id="pwd2" name="pwd2" required onkeyup="passConfirm()"><br><span id="confirmMsg"></span></td>
		...
		<tr style="border-top:20px solid white;">
			...
			<td style="padding-left: 50px;"><input type="text" class="myinfo_email" id="myinfo_email" name="email" value="${login_info.email}"><br></td>
		</tr>
		<tr style="border-top:20px solid white;">
			<td  style="padding-left: 80px;"><label for="phone">휴대전화</label></td>
			<td style="padding-left: 50px;"><input type="tel" name="phone" value="${login_info.phone}"><br></td>
		</tr>
		<tr style="border-top:20px solid white;">
		
			<td><label for="adr"></label></td>
			<td style="width:310px;padding-left: 50px;"><input type="text" class="address_input_1" name=adr id="adr" placeholder="우편번호" value="${myinfo_adr1}" ><br></td>	
			<td style="padding-left: 10px;"><input type="button" class="adrchk" onclick="sample6_execDaumPostcode()" style="background-color:#323232; color: white; border:#323232;" value="우편번호 찾기"><br></td>
		</tr>
		<tr style="border-top:20px solid white;">
