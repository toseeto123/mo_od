...
<body>
	...
	<div id="header">
		<h1 class="logo">
			<a href="index.jsp">묻 : <span class="logo2">mo_od</span></a>
		</h1>
	</div>
		...
		<form action="join.do" method="post" name="join" id="join">
			...
			<div id="content">
				...
				<div>
					...
					<span class="box int_pass"> <input type="password" id="pwd"
						name="pwd" class="string" maxlength="20">
					</span>
				</div>
				...
				<div>
					...
					<span class="box int_string_check"> <input type="password"
						id="pwd2" name="pwd2" class="string" maxlength="20"
				...
				<div>
					...
					<span class="box string_name"> <input type="text" id="name"
						name="name" class="string" maxlength="20">
					</span>
					...
					<div id="bir_wrap">
						<div>
							<input type="radio" value="10-19" class="age" name="age" id="age"
								checked />10대 <input type="radio" value="20-29" class="age"
								name="age" id="age" />20대 <input type="radio" value="30-39"
								class="age" name="age" id="age" />30대 <input type="radio"
								value="40-49" class="age" name="age" id="age" />40대 <input
								type="radio" value="50대이상" class="age" name="age" id="age" />50대이상
						</div>
					</div>
				</div>
				...
				<div>
					...
					<div>
						<input type="text" id="email" name="email"
							class="email box string_email" maxlength="100" placeholder="필수입력">
					</div>
					<span class="final_mail_ck">이메일을 입력해주세요.</span> <span
						class="mail_input_box_warn"></span>
					<div class="mail_check_wrap">
						<div class="mail_check_input_box" id="mail_check_input_box_false">
							<input class="mail_check_input" id="email1" disabled="disabled"
								required>
						</div>
				...
				<div>
					...
					<div class="box string_mobile">
						<input type="tel" id="phone" name="phone" class="string"
				...
				<div>
					...
					<input type="text" class="address_input_1" name=adr id="adr"
						placeholder="우편번호" required> <input type="button"
						onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
					<input type="text" class="address_input_2" name="adr2" id="adr2"
						placeholder="주소" required><br> <input type="text"
						class="address_input_3" name="adr3" id="adr3" placeholder="상세주소"
						required>
				</div>
