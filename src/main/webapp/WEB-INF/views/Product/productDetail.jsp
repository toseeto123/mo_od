	...
	<main id="main">
		<form method="post" action="cateinsert.do">
						...
						<div class="d-flex align-items-center">
							...
							<ol>
								...
								<c:if test="${list.pro_categoryserial  eq 'A0' }">
									<li><a href="/A0categoryList">매트리스</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								<c:if test="${list.pro_categoryserial  eq 'A1' }">
									<li><a href="/A1categoryList">침대프레임</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								<c:if test="${list.pro_categoryserial  eq 'B0' }">
									<li><a href="/B0categoryList">무드등</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								<c:if test="${list.pro_categoryserial  eq 'B1' }">
									<li><a href="/B1categoryList">스탠드조명</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								<c:if test="${list.pro_categoryserial  eq 'C0' }">
									<li><a href="/C0categoryList">옷장/행거</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								<c:if test="${list.pro_categoryserial  eq 'C1' }">
									<li><a href="/C1categoryList">서랍</a>&nbsp; <i
										class="fa fa-angle-right" aria-hidden="true"></i></li>
								</c:if>
								...
								<div class="portfolio-details-slider swiper">
									<div class="swiper-wrapper align-items-center">
										...
										<div class="swiper-slide">
											<img src="resources/assets/img/product/${list.pro_img1}"
												alt="">
										</div>
										<c:if test="${!empty list.pro_img2}">
											<div class="swiper-slide">
												<img src="resources/assets/img/product/${list.pro_img2}"
													alt="">
											</div>
										</c:if>
										<c:if test="${!empty list.pro_img3}">
											<div class="swiper-slide">
												<img src="resources/assets/img/product/${list.pro_img3}"
													alt="">
											</div>
										</c:if>
										<c:if test="${!empty list.pro_img4}">
											<div class="swiper-slide">
												<img src="resources/assets/img/product/${list.pro_img4}"
													alt="">
											</div>
										</c:if>
										<c:if test="${!empty list.pro_img5}">
											<div class="swiper-slide">
												<img src="resources/assets/img/product/${list.pro_img5}"
													alt="">
											</div>
										</c:if>
							...
							<div class="col-lg-4">
								...
								<div class="portfolio-info">
									...
									<ul>
										...
										<li><strong>가 격</strong>: <fmt:formatNumber
												value="${list.pro_price}" type="currency" currencySymbol="₩" /></li>
										<li><strong>옵 션</strong>:<br> <c:if
												test="${empty list.pro_option1}">
												<label for="chk_option"><span class="chk_option">선택안함</span></label>
												<input type="radio" value="daaaa" id="chk_option"
													name="radioOption" checked="checked">
												<br>
											</c:if> <c:if test="${!empty list.pro_option1}">
												<label for="chk_option 1"><span class="chk_option">${list.pro_option1}</span></label>
												<input type="radio" value="daaaa" id="chk_option 1"
													name="radioOption">
												<br>
											</c:if> <c:if test="${!empty list.pro_option2}">
												<label for="chk_option 2"><span class="chk_option">${list.pro_option2}</span></label>
												<input type="radio" value="daaaa" id="chk_option 2"
													name="radioOption">
												<br>
											</c:if>
			</c:if>
			<c:if test="${!empty list.pro_option3}">
				...
				<input type="radio" value="daaaa" id="chk_option 3"
					name="radioOption">
				<br>
			</c:if>
			...
			<li>
				...
				<div class="portfolio-description">
					...
					<br>
					<br> <input type="submit" value="장바구니" class="payBtn">
				</div>
				</div>
		</form>
		<style>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="member">
							<img src="resources/assets/img/team/team-1.jpg" class="img-fluid"
								alt="">
					...
					<div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
						<div class="member">
							<img src="resources/assets/img/team/team-2.jpg" class="img-fluid"
								alt="">
							<div class="member-info">
								<div class="member-info-content">
									<h4>Sarah Jhonson</h4>
					...
					<div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
						<div class="member">
							<img src="resources/assets/img/team/team-3.jpg" class="img-fluid"
								alt="">
							<div class="member-info">
								<div class="member-info-content">
					...
					<div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.3s">
						<div class="member">
							<img src="resources/assets/img/team/team-4.jpg" class="img-fluid"
								alt="">
							<div class="member-info">
								<div class="member-info-content">
									<h4>Amanda Jepson</h4>
